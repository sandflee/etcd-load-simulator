...
func (c counter) String() string {
	return fmt.Sprintf("create: %d,create_failed: %d,update: %d,update_failed: %d, list: %d,list_failed:%d",c.create_num,c.fail_create_num,c.update_num,c.fail_update_num,c.list_num,c.fail_list_num)
}
